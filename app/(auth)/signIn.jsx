...
const signIn = () => {
  ...
  return (
    <Container centerContent={true} centerHorizontal={true}>
      <View className="flex border-[#D9D9D9] border rounded-[10px] w-[365px] h-[460px] p-[20px]">
        <View>
          <Text className={"font-extrabold text-[20px]"}>Welcome Back</Text>
        ...
        >
          <CustomButton
            label="Login"
            styles="bg-white py-[5px] px-[57px] my-[5px] mx-[5px] rounded-[3px]"
            textStyle="font-bold text-[14px] text-[#0A0A0A]"
          />
          <CustomButton
            label="Create Account"
            styles="w-[150px] mr-[5px]"
